...
const SalesManagementSystem = () => {
  ...
  const fetchSalesData = async () => {
    ...
    try {
      ...
      if (data.data) {
        ...
        const discount = data.data.reduce(
          (sum, item) => sum + (item.totalAmount - item.finalAmount),
          0
        );
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-gray-50 p-4 rounded-lg">
                <div>
                  ...
                  <p className="font-semibold">
                    ₹{selectedSale.pricePerUnit?.toLocaleString()}
                  </p>
                </div>
                <div>
                  ...
                  <p className="font-semibold">
                    {selectedSale.discountPercentage}%
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-semibold text-black-600 text-lg">
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <div
        className={`fixed left-0 top-0 h-full w-60 bg-white border-r border-gray-200 p-4 z-50 transition-transform duration-300 lg:translate-x-0 ${
        ...
        <nav className="space-y-1">
          ...
          <div className="pt-4">
            ...
            <div className="ml-6 mt-2 space-y-1">
              <a
                href="#"
                className="flex items-center gap-2 px-3 py-2 text-sm font-semibold hover:bg-gray-100 rounded-lg"
              >
                Proforma Invoices
              </a>
              <a
